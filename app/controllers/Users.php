    ...
    class Users extends Controller
    {
        ...
        public function register()
        {
            ...
            if ($_SERVER['REQUEST_METHOD']=='POST') {
                ...
                if ( empty($data['email']) ) {
                    ...
                    // Check email
                    if ( $this->userModel->getUserByName($data['email']) ) {
        ...
        public function login()
        {
            ...
            if ($_SERVER['REQUEST_METHOD']=='POST') {
                ...
                if ( empty($data['user']) ) {
                    $data['name_err'] = 'Please inform your name';
                } else if (! $this->userModel->getUserByName($data['user']) ) {
                    // User not found
                ...
                if ( empty($data['name_err']) && empty($data['password_err']) ) {
                    ...
                    $userAuthenticated = $this->userModel->login($data['user'], $data['password']);
                    if ( $userAuthenticated) {
                        ...
                        $data = [
                            'user' => $_POST['user'],
                            'password' => '',
                            'name_err' => 'User or Password are incorrect',
                            'password_err' => 'User or Password are incorrect',
                        ];
